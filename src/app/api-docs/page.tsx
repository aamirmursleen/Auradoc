...
async function sendForSignature() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative py-20 bg-[#1F1F1F]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-[#c4ff0e]/10 rounded-full border border-[#c4ff0e]/20 mb-6">
              <Code className="w-4 h-4 text-[#c4ff0e]" />
              <span className="text-[#c4ff0e] text-sm font-medium">Developer API</span>
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white leading-tight mb-6">
              Build with the
              <span className="block mt-2 bg-[#c4ff0e] bg-clip-text text-transparent">
                MamaSign API
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/sign-up?developer=true" className="group inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-black bg-[#c4ff0e] rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                Get API Key
                <Key className="w-5 h-5 ml-2" />
              </Link>
              <a href="#docs" className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white border-2 border-[#2a2a2a] rounded-xl hover:border-[#c4ff0e] hover:bg-[#2a2a2a] transition-all duration-300">
                View Documentation
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
                Get Started in
                <span className="bg-[#c4ff0e] bg-clip-text text-transparent"> Minutes</span>
              </h2>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-center">
                    <Check className="w-5 h-5 text-[#c4ff0e] mr-3" />
            ...
            <div className="relative">
              <div className="bg-[#1e1e1e] rounded-2xl overflow-hidden shadow-2xl">
                <div className="flex items-center justify-between px-4 py-3 bg-[#2a2a2a] border-b border-[#2a2a2a]">
                ...
                <pre className="p-4 overflow-x-auto text-sm">
                  <code className="text-gray-300">{exampleCode}</code>
                </pre>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="p-6 bg-[#1e1e1e] rounded-xl border border-[#2a2a2a] hover:shadow-lg transition-all duration-300">
      ...
      {/* API Endpoints */}
      <section id="docs" className="py-20 bg-[#1e1e1e]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              API Endpoints
          ...
          <div className="bg-[#1e1e1e] border border-[#2a2a2a] rounded-2xl p-6">
            <div className="space-y-4">
              {endpoints.map((endpoint, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between p-4 bg-[#1e1e1e] rounded-lg border border-[#2a2a2a] hover:border-[#c4ff0e] hover:shadow-md transition-all duration-300"
                >
          ...
          <div className="mt-8 text-center">
            <Link href="/api-docs/reference" className="inline-flex items-center text-[#c4ff0e] hover:text-[#c4ff0e]/80 font-medium">
      ...
      <section className="py-20 bg-[#1e1e1e]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center space-x-2 px-4 py-2 bg-[#c4ff0e]/10 rounded-full border border-[#c4ff0e]/20 mb-6">
                <Webhook className="w-4 h-4 text-[#c4ff0e]" />
                <span className="text-[#c4ff0e] text-sm font-medium">Webhooks</span>
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-center text-gray-300">
                    <div className="w-2 h-2 bg-[#c4ff0e] rounded-full mr-3" />
            ...
            <div className="relative">
              <div className="bg-[#2a2a2a] rounded-2xl overflow-hidden">
                <div className="flex items-center justify-between px-4 py-3 border-b border-[#2a2a2a]">
                  <span className="text-gray-300 text-sm">Webhook Payload</span>
                  <button
                ...
                <pre className="p-4 overflow-x-auto text-sm">
                  <code className="text-gray-300">{webhookExample}</code>
                </pre>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-[#1e1e1e]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {sdks.map((sdk, index) => (
              <div key={index} className="p-6 bg-[#1e1e1e] border border-[#2a2a2a] rounded-xl hover:shadow-lg transition-all duration-300">
                <div className="flex items-center mb-4">
                  <span className="text-2xl mr-3">{sdk.icon}</span>
                  <h3 className="text-lg font-semibold text-white">{sdk.name}</h3>
                </div>
                <div className="flex items-center bg-[#1e1e1e] rounded-lg p-3">
      ...
      <section className="py-20 bg-[#c4ff0e]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/sign-up?developer=true" className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-[#c4ff0e] bg-black rounded-lg shadow-lg hover:bg-[#1e1e1e] transition-all duration-300">
              Get Free API Key
              <Key className="w-5 h-5 ml-2" />
            </Link>
