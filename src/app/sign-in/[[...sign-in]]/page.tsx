        ...
        <div className="w-full max-w-md">
          <div className="bg-gray-50 rounded-2xl shadow-2xl p-8 border border-gray-200">
            ...
            <form className="space-y-5" onSubmit={(e) => {
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input type="checkbox" className="w-4 h-4 rounded border-gray-200 bg-gray-100 text-cyan-500 focus:ring-cyan-500" />
                  <span className="ml-2 text-sm text-gray-600">Remember me</span>
                </label>
                <a href="https://mamasign.com/sign-in" className="text-sm text-cyan-600 hover:text-cyan-700 transition-colors">
                  Forgot password?
                </a>
              </div>
            ...
            <p className="mt-8 text-center text-gray-600">
              ...
              <Link href="/sign-up" className="text-cyan-600 hover:text-cyan-700 font-medium transition-colors">
                Sign up
              </Link>
            </p>
          </div>
