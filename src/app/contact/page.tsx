        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            {contactOptions.map((option, index) => (
              <div key={index} className="p-8 bg-gray-50 rounded-2xl text-center hover:shadow-lg transition-all duration-300">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-6">
                  <option.icon className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">{option.title}</h3>
                <p className="text-gray-600 mb-4">{option.description}</p>
                <p className="text-blue-600 font-medium mb-2">{option.action}</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              {isSubmitted ? (
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      type="submit"
                      className="w-full inline-flex items-center justify-center px-6 py-4 text-lg font-medium text-white bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                    >
                      Send Message
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <div className="space-y-4">
                  {faqs.map((faq, index) => (
                    ...
                    >
                      <span className="text-gray-700 group-hover:text-blue-600">{faq.question}</span>
                      <ArrowRight className="w-4 h-4 text-gray-400 group-hover:text-blue-600" />
                    </Link>
                  ))}
                </div>
                <Link href="/help" className="inline-flex items-center text-blue-600 font-medium mt-6 hover:text-blue-700">
                  Visit Help Center
              ...
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 text-white">
                ...
                <Link href="/contact/enterprise" className="inline-flex items-center text-blue-400 font-medium hover:text-blue-300">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <div className="flex items-center gap-4">
                  <a href="#" className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center hover:bg-blue-100 hover:text-blue-600 transition-colors">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {offices.map((office, index) => (
              <div key={index} className="p-8 bg-gray-50 rounded-2xl">
                ...
                <span className="text-sm text-blue-600 font-medium">{office.type}</span>
