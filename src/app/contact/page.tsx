        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            {contactOptions.map((option, index) => (
              <div key={index} className="p-8 bg-[#2a2a2a] backdrop-blur-xl rounded-2xl text-center hover:shadow-lg hover:shadow-[#c4ff0e]/20 transition-all duration-300 border border-[#3a3a3a]">
                ...
                <p className="text-[#c4ff0e] font-medium mb-2">{option.action}</p>
            ...
            <div className="bg-[#2a2a2a] backdrop-blur-xl rounded-2xl p-8 shadow-lg border border-[#3a3a3a]">
              {isSubmitted ? (
                <div className="text-center py-12">
                  <div className="w-20 h-20 bg-[#c4ff0e]/20 rounded-full flex items-center justify-center mx-auto mb-6">
                    <CheckCircle className="w-10 h-10 text-[#c4ff0e]" />
                  </div>
                  ...
                  <button
                    ...
                    className="text-[#c4ff0e] font-medium hover:text-[#a8d60c]"
                  >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid sm:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 rounded-lg border border-[#3a3a3a] bg-[#1F1F1F] text-white focus:border-[#c4ff0e] focus:ring-2 focus:ring-[#c4ff0e]/20 outline-none transition-all"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        className="w-full px-4 py-3 rounded-lg border border-[#3a3a3a] bg-[#1F1F1F] text-white focus:border-[#c4ff0e] focus:ring-2 focus:ring-[#c4ff0e]/20 outline-none transition-all resize-none"
                    ...
                    <button
                      type="submit"
                      className="w-full inline-flex items-center justify-center px-6 py-4 text-lg font-medium text-black bg-[#c4ff0e] rounded-xl shadow-lg hover:bg-[#a8d60c] transition-all duration-300"
                    >
                      Send Message
            ...
            <div className="space-y-8">
              ...
              <div className="bg-[#2a2a2a] backdrop-blur-xl rounded-2xl p-8 shadow-lg border border-[#3a3a3a]">
                <h3 className="text-xl font-semibold text-white mb-6 flex items-center">
                  <HelpCircle className="w-6 h-6 text-[#c4ff0e] mr-2" />
                ...
                <div className="space-y-4">
                  {faqs.map((faq, index) => (
                    <Link
                      key={index}
                      href={faq.link}
                      className="flex items-center justify-between p-4 bg-[#1F1F1F] rounded-lg hover:bg-[#252525] transition-colors group"
                    >
                      <span className="text-gray-300 group-hover:text-[#c4ff0e]">{faq.question}</span>
                      <ArrowRight className="w-4 h-4 text-gray-400 group-hover:text-[#c4ff0e]" />
                    </Link>
                  ))}
                </div>
                <Link href="/help" className="inline-flex items-center text-[#c4ff0e] font-medium mt-6 hover:text-[#a8d60c]">
                  Visit Help Center
              ...
              {/* For Enterprise */}
              <div className="bg-[#2a2a2a] rounded-2xl p-8 text-white border border-[#3a3a3a]">
                <Building2 className="w-12 h-12 mb-4 text-[#c4ff0e]" />
                ...
                <Link href="/contact/enterprise" className="inline-flex items-center text-[#c4ff0e] font-medium hover:text-[#a8d60c]">
              ...
              <div className="bg-[#2a2a2a] backdrop-blur-xl rounded-2xl p-8 shadow-lg border border-[#3a3a3a]">
                ...
                <div className="flex items-center gap-4">
                  <a href="#" className="w-12 h-12 bg-[#1F1F1F] rounded-full flex items-center justify-center hover:bg-[#c4ff0e]/20 hover:text-[#c4ff0e] text-gray-300 transition-colors">
