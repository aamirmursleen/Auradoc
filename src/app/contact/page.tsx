          ...
          <div className="grid md:grid-cols-3 gap-8">
            {contactOptions.map((option, index) => (
              <div key={index} className="p-8 bg-gray-100/50 backdrop-blur-xl rounded-2xl text-center hover:shadow-lg hover:shadow-cyan-500/20 transition-all duration-300 border border-gray-200 dark:border-gray-700/50">
                ...
                <p className="text-cyan-600 font-medium mb-2">{option.action}</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              {isSubmitted ? (
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      type="submit"
                      className="w-full inline-flex items-center justify-center px-6 py-4 text-lg font-medium text-gray-900 bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                    >
                      Send Message
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  {faqs.map((faq, index) => (
                    <Link
                      key={index}
                      href={faq.link}
                      className="flex items-center justify-between p-4 bg-gray-50/50 rounded-lg hover:bg-gray-100 transition-colors group"
                    >
                      <span className="text-gray-700 group-hover:text-cyan-600">{faq.question}</span>
                      <ArrowRight className="w-4 h-4 text-gray-600 group-hover:text-cyan-600" />
                    </Link>
                  ))}
                </div>
                <Link href="/help" className="inline-flex items-center text-cyan-600 font-medium mt-6 hover:text-cyan-700">
                  Visit Help Center
              ...
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 text-gray-900 border border-gray-200 dark:border-gray-700/50">
                ...
                <Link href="/contact/enterprise" className="inline-flex items-center text-cyan-600 font-medium hover:text-cyan-700">
