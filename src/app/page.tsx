...
const TemplatesMockup = () => {
  ...
  return (
    <Link href="/templates" className="block">
      <div className="relative w-full h-full min-h-[400px] bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 shadow-2xl border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300 cursor-pointer group">
        <div className="bg-gray-800/80 backdrop-blur-xl rounded-xl shadow-lg overflow-hidden border border-gray-700/50 group-hover:border-cyan-500/30 transition-all">
          {/* Header */}
          ...
          <div className="p-6 grid grid-cols-2 gap-4">
            {templates.map((template, idx) => (
              <div key={idx} className="cursor-pointer block">
                <div className="bg-gray-900/50 rounded-lg p-3 border-2 border-gray-600 group-hover:border-cyan-400/50 transition-all duration-300 transform group-hover:scale-[1.02]">
                  <div className="h-28 mb-2">
                    <ResumePreview type={template.name} color={template.color} />
                  </div>
                  <p className="text-xs font-medium text-gray-300 text-center">{template.name}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="px-6 pb-6">
            <div className="block w-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white py-3 rounded-lg font-medium group-hover:shadow-lg group-hover:shadow-cyan-500/30 transition-all text-center">
              Choose Template
            </div>
          </div>
        </div>
        ...
        {/* Floating Badge */}
        <div className="absolute -top-4 -right-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-4 py-2 rounded-full shadow-lg shadow-cyan-500/30 flex items-center space-x-2">
...
const SignDocumentMockup = () => {
  return (
    <Link href="/sign-document" className="block">
      <div className="relative w-full h-full min-h-[400px] bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 shadow-2xl border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 cursor-pointer group">
        <div className="bg-gray-800/80 backdrop-blur-xl rounded-xl shadow-lg overflow-hidden border border-gray-700/50 group-hover:border-purple-500/30 transition-all">
          {/* Header */}
          ...
          {/* Document Preview */}
          <div className="p-6">
            <div className="bg-gray-900/50 rounded-lg p-6 border-2 border-dashed border-purple-500/30 min-h-[200px] relative">
              ...
              <div className="absolute bottom-6 right-6 bg-gradient-to-r from-purple-900/50 to-pink-900/50 border-2 border-purple-500/50 rounded-lg p-4 w-40 group-hover:border-purple-400 transition-all">
                <div className="flex items-center justify-center space-x-2">
                  <FileSignature className="w-5 h-5 text-purple-400" />
                  <span className="text-xs font-medium text-purple-400">Sign Here</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-center justify-between bg-purple-900/30 p-3 rounded-lg border border-purple-500/20">
                <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between bg-gray-800/50 p-3 rounded-lg border border-gray-700/50">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-400">Jane Smith</span>
                </div>
        ...
        {/* Notification Badge */}
        <div className="absolute -top-4 -right-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-4 py-2 rounded-full shadow-lg shadow-purple-500/30 flex items-center space-x-2">
...
const InvoiceMockup = () => {
  return (
    <Link href="/create-invoice" className="block">
      <div className="relative w-full h-full min-h-[400px] bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 shadow-2xl border border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-300 cursor-pointer group">
        <div className="bg-gray-800/80 backdrop-blur-xl rounded-xl shadow-lg overflow-hidden border border-gray-700/50 group-hover:border-emerald-500/30 transition-all">
          {/* Header */}
          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-sm font-bold text-white">Your Company</p>
                  <p className="text-xs text-gray-400">Professional Invoices</p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-xs text-gray-500">Date</p>
                <p className="text-sm font-semibold text-gray-300">Dec 11, 2024</p>
              </div>
            </div>

            {/* Invoice Items */}
            <div className="space-y-2 mb-4">
              <div className="flex justify-between bg-gray-900/50 p-3 rounded border border-gray-700/50">
                <span className="text-sm text-gray-300">Service Item 1</span>
                <span className="text-sm font-medium text-white">$500.00</span>
              </div>
              <div className="flex justify-between bg-gray-900/50 p-3 rounded border border-gray-700/50">
                <span className="text-sm text-gray-300">Service Item 2</span>
                <span className="text-sm font-medium text-white">$750.00</span>
              </div>
            </div>
            ...
            <div className="mt-4 flex justify-center">
              <div className="bg-emerald-900/50 text-emerald-400 px-4 py-2 rounded-full text-sm font-medium border border-emerald-500/30">
                Ready to Send
              </div>
            </div>
          </div>
...
const VerifyMockup = () => {
  return (
    <Link href="/verify" className="block">
      <div className="relative w-full h-full min-h-[400px] bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 shadow-2xl border border-orange-500/20 hover:border-orange-500/40 transition-all duration-300 cursor-pointer group">
        <div className="bg-gray-800/80 backdrop-blur-xl rounded-xl shadow-lg overflow-hidden border border-gray-700/50 group-hover:border-orange-500/30 transition-all">
          {/* Header */}
          ...
          <div className="p-6">
            ...
            <div className="bg-gradient-to-br from-orange-900/30 to-red-900/30 rounded-lg p-6 border-2 border-dashed border-orange-500/30 mb-6 group-hover:border-orange-400/50 transition-all">
              <div className="flex flex-col items-center justify-center space-y-3">
                <FileCheck className="w-12 h-12 text-orange-400" />
                <p className="text-sm font-medium text-gray-300">document.pdf</p>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between bg-emerald-900/30 p-4 rounded-lg border border-emerald-500/30">
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-emerald-400" />
                  <div>
                    <p className="text-sm font-medium text-white">Hash Verified</p>
                    <p className="text-xs text-gray-400">SHA-256 Match</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between bg-emerald-900/30 p-4 rounded-lg border border-emerald-500/30">
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-emerald-400" />
                  <div>
                    <p className="text-sm font-medium text-white">No Modifications</p>
                    <p className="text-xs text-gray-400">Document Intact</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between bg-orange-900/30 p-4 rounded-lg border border-orange-500/30">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">Dec 11, 2024 10:30 AM</p>
                  </div>
                </div>
              </div>
            </div>
...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="overflow-hidden bg-gray-950">
      ...
      {/* Stats Section */}
      <section className="py-12 md:py-16 bg-gray-900/50 border-y border-gray-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center p-4 md:p-6 rounded-xl hover:bg-gray-800/30 transition-all duration-300">
                  ...
                  <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center ${!isEven ? 'lg:grid-flow-col-dense' : ''}`}>
                    ...
                    <div className={`${!isEven ? 'lg:col-start-2' : ''} order-2 lg:order-none`}>
                      ...
                      <div className="text-center lg:text-left">
                        <Link
                          href={feature.href}
                          className={`inline-flex items-center justify-center px-5 md:px-6 py-2.5 md:py-3 text-sm md:text-base font-medium text-white bg-gradient-to-r ${feature.gradient} rounded-lg hover:shadow-lg hover:shadow-cyan-500/30 transition-all duration-500 ease-out transform hover:scale-105 hover:-translate-y-1`}
                        >
                          Try {feature.title}
      ...
      <section className="py-12 md:py-20 bg-gray-900/50 border-y border-gray-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-gray-700/50 hover:border-cyan-500/30 hover:bg-gray-800/70 hover:shadow-xl hover:shadow-cyan-500/10 transition-all duration-500 ease-out transform hover:-translate-y-2"
              >
