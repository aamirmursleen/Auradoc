        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/security/whitepaper" className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-black bg-primary rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                Download Security Whitepaper
                <ArrowRight className="w-5 h-5 ml-2" />
              </Link>
              <Link href="/contact" className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-foreground border-2 border-primary rounded-xl hover:border-primary/80 hover:bg-primary/10 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {securityFeatures.map((feature, index) => (
              <div key={index} className="p-8 bg-muted border border-border rounded-2xl hover:shadow-lg transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {certifications.map((cert, index) => (
              <div key={index} className="p-8 bg-muted rounded-2xl border border-border text-center hover:shadow-lg transition-all duration-300">
          ...
          <div className="mt-12 text-center">
            <Link href="/compliance" className="inline-flex items-center text-primary font-medium hover:text-primary/80">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {securityPractices.map((category, index) => (
              <div key={index} className="bg-muted border border-border rounded-2xl p-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link href="/security/disclosure" className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-black bg-primary rounded-lg shadow-lg hover:bg-primary/90 transition-all duration-300">
                Report a Vulnerability
                <ArrowRight className="w-5 h-5 ml-2" />
              </Link>
            </div>
            <div className="bg-muted rounded-2xl p-8 border border-border">
              <h3 className="text-xl font-semibold text-foreground mb-6">Program Highlights</h3>
