...
const CompliancePage: React.FC = () => {
  ...
  return (
    <div className="overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/contact" className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-gray-900 bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                Request Compliance Pack
                <ArrowRight className="w-5 h-5 ml-2" />
              </Link>
              <a href="#regulations" className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-gray-700 bg-gray-50/80 border-2 border-gray-200/50 rounded-xl hover:border-gray-600 hover:bg-gray-100/80 transition-all duration-300">
                View Certifications
              </a>
            </div>
          </div>
      ...
      {/* Regulations */}
      <section id="regulations" className="py-20 bg-gray-50/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {regulations.map((reg) => (
              <div key={reg.id} className="bg-gray-50/80 border border-gray-200/50 rounded-2xl p-8 hover:shadow-lg transition-all duration-300">
                <div className="flex items-center justify-between mb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-cyan-500 via-blue-600 to-purple-600 rounded-xl flex items-center justify-center">
                    <reg.icon className="w-6 h-6 text-gray-900" />
                  </div>
                ...
                <p className="text-gray-700 text-sm mb-4">{reg.description}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {industries.map((industry, index) => (
              <div key={index} className="bg-gray-50/80 rounded-xl p-8 border border-gray-200/50 hover:shadow-lg transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {documents.map((doc, index) => (
              <div key={index} className="flex items-center justify-between p-6 bg-gray-50/80 border border-gray-200/50 rounded-xl hover:bg-blue-600/20 transition-colors cursor-pointer">
      ...
      <section className="py-20 bg-gray-50/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <div key={index} className="bg-gray-50/80 rounded-xl p-6 border border-gray-200/50">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FileCheck className="w-16 h-16 text-gray-900/80 mx-auto mb-6" />
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/sign-up" className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-gray-900 border-2 border-white rounded-lg hover:bg-white/10 transition-all duration-300">
              Start Free Trial
            </Link>
          </div>
        </div>
